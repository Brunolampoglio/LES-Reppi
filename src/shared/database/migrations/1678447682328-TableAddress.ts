...
export class TableAddress1678447682328 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD "street_type" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD "type_residence" character varying NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" DROP COLUMN "type_residence"`);
