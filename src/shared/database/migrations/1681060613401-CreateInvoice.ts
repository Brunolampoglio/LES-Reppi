...
export class CreateInvoice1681060613401 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "cartProducts" DROP CONSTRAINT "FK_55eacde447998e4f9a1c3815624"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cartProducts" DROP COLUMN "createdAtId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cartProducts" ADD "product_id" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "cartProducts" DROP COLUMN "cart_id"`);
    await queryRunner.query(
      `ALTER TABLE "cartProducts" ADD "cart_id" uuid NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "cartProducts" DROP COLUMN "cart_id"`);
    await queryRunner.query(
      `ALTER TABLE "cartProducts" ADD "cart_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "cartProducts" DROP COLUMN "product_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cartProducts" ADD "createdAtId" uuid`,
    );
    await queryRunner.query(`DROP TABLE "invoices"`);
    await queryRunner.query(
      `ALTER TABLE "cartProducts" ADD CONSTRAINT "FK_55eacde447998e4f9a1c3815624" FOREIGN KEY ("createdAtId") REFERENCES "cartProducts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
